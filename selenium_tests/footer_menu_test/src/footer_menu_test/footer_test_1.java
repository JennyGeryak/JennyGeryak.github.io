...
public class footer_test_1 {
	  ...
	  public void testUntitled() throws Exception {
	    ...
	    driver.findElement(By.cssSelector("i.fa.fa-facebook-square")).click();
	    driver.findElement(By.cssSelector("i.fa.fa-linkedin-square")).click();
	    driver.findElement(By.cssSelector("i.fa.fa-instagram")).click();
	    driver.findElement(By.cssSelector("i.fa.fa-github-square")).click();
	  }
